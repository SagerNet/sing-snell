...
const (
	// Surge 6.7.0 (11520): SGConnectorPool: keeps at most 10 reusable connectors.
	PoolSize = 10
	// Surge 6.7.0 (11520): SGConnectorPool: keeps pooled reusable connectors for 180 seconds.
	PoolMaxAge = 180 * time.Second
	// Surge 6.7.0 (11520): SGConnectorPool: timer interval is 20 seconds.
