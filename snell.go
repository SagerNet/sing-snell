...
const (
	// Surge 6.7.0 (11520): SNConnectorEngineAdapterV4::encryptData:outData: / FUN_100014610: uses these record constants.
	HeaderVersion   = 0x04
	HeaderPlainLen  = 7
	AEADTagLen      = 16
...
// Surge 6.7.0 (11520): SNConnectorV4::targetHandshakeData: writes request version 1.
const RequestVersion = 0x01

const (
	// Surge 6.7.0 (11520): SNConnectorV4::targetHandshakeData / SGUDPConnectorSnellV4::targetHandshakeData: uses these request commands.
	CommandPing      = 0x00
	CommandConnect   = 0x01
...
const (
	// snell-server v6.0.0b4: FUN_001414e0: uses these reply opcodes.
	ReplyTunnel = 0x00
	ReplyPong   = 0x01
	ReplyError  = 0x02
)
...
const (
	// Surge 6.7.0 (11520): SGUDPConnectorSnellV4::sendData:toAddress:metadata: uses these UDP opcodes and address tags.
